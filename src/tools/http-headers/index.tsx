    ...
    <ToolLayout meta={meta}>
      <div className="space-y-4">
        ...
        <div className="grid gap-2">
          {filteredHeaders.map((header) => (
            ...
            >
              ...
              {header.example && (
                <div className="p-2 bg-bg-tertiary rounded text-xs font-mono text-text-tertiary overflow-x-auto">
                  {header.example}
                </div>
              )}
            </div>
        ...
        {filteredHeaders.length === 0 && (
          <div className="text-center text-text-tertiary py-8">未找到匹配的请求头</div>
        )}
      </div>
    </ToolLayout>
  )
